...
-- 資料庫: `skillsB17300`
--
CREATE DATABASE IF NOT EXISTS `skillsB17300` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `skillsB17300`;
...
(2, '公告綜合高中一年級英數補救教學時間、\r\n 上課日期：10/27.11/3.11/10.11/24 共計四次、\r\n 上課時間：早上 8:00~11:50 半天、\r\n 費用：全程免費、\r\n 參加同學：綜合科一年級第一次段考成績需加強者、\r\n 已將名單送交各班及導師、\r\n 參加同學請帶紙筆。課本。第一次段考考卷、\r\n 並將家長通知單給家長、\r\n 若有任何疑問、\r\n 請洽綜合高中學程主任', 1),
...
(5, '11 月 23 日（星期五）將於彰化縣田尾鄉菁芳園休閒農場、\r\n 舉辦「高中職生涯輔導知能研習」\r\n 中區學校每校至多 2 名、\r\n 以普通科、專業類科教師優先報名參加、\r\n 生涯規劃教師次之，參加人員公差假、\r\n 並核實派代課、\r\n 當天還有專車接送 (8:35 前在員林火車站集合）\r\n 如此好康的機會，怎能錯過？！\r\n 熱烈邀請師長們向輔導室（分機 234) 報名、\r\n 名額有限，動作要快！！\r\n 報名截止日期：本周四 10 月 25 日 17:00 前！', 1),
(6, '台視百萬大明星節目辦理海選活動、\r\n 時間：101 年 10 月 27 日下午 13 時、\r\n 地點：彰化', 1);
...
(5, '球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1, 1),
...
(1, '電影名稱 A', 1, '1 分 30 秒', '2022-03-05', '發行商 A', '導演 A', '03B01v.mp4', '03B01.png', '內容與劇情介紹 A', 1, 1),
(2, '電影名稱 B', 2, '1 分 30 秒', '2022-03-05', '發行商 B', '導演 B', '03B02v.mp4', '03B02.png', '內容與劇情介紹 B', 2, 1),
(3, '電影名稱 C', 3, '1 分 30 秒', '2022-03-06', '發行商 C', '導演 C', '03B03v.mp4', '03B03.png', '內容與劇情介紹 C', 3, 1),
(4, '電影名稱 D', 4, '1 分 30 秒', '2022-03-06', '發行商 D', '導演 D', '03B04v.mp4', '03B04.png', '內容與劇情介紹 D', 4, 1),
(5, '電影名稱 E', 1, '1 分 30 秒', '2022-03-07', '發行商 E', '導演 E', '03B05v.mp4', '03B05.png', '內容與劇情介紹 E', 5, 1),
(6, '電影名稱 F', 2, '1 分 30 秒', '2022-03-07', '發行商 F', '導演 F', '03B06v.mp4', '03B06.png', '內容與劇情介紹 F', 6, 1);
...
INSERT INTO `q3t8_book` (`id`, `movie`, `date`, `time`, `seat`, `buydate`) VALUES
(1, '電影名稱 A', '2022-03-07', 4, 'a:2:{i:0;s:1:\"7\";i:1;s:1:\"8\";}', '2022-03-07');
...
INSERT INTO `q4t8_order` (`id`, `acc`, `name`, `mail`, `addr`, `tel`, `date`, `buy`, `total`) VALUES
(1, 'test', '測試 01', 'test@test.com', 'test road', '8888-888-888', '2022-03-07', 'a:2:{i:1;s:1:\"1\";i:6;s:1:\"1\";}', 29200);
...
(1, 'test', 'test', '測試 01', 'test@test.com', 'test road', '8888-888-888', '2021-11-21');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t3_title`
--
ALTER TABLE `q1t3_title`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t4_maqe`
--
ALTER TABLE `q1t4_maqe`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t5_mvim`
--
ALTER TABLE `q1t5_mvim`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t6_img`
--
ALTER TABLE `q1t6_img`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t7_total`
--
ALTER TABLE `q1t7_total`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t8_footer`
--
ALTER TABLE `q1t8_footer`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t9_news`
--
ALTER TABLE `q1t9_news`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t10_admin`
--
ALTER TABLE `q1t10_admin`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q1t12_menu`
--
ALTER TABLE `q1t12_menu`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q2t3_visit`
--
ALTER TABLE `q2t3_visit`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q2t6_user`
--
ALTER TABLE `q2t6_user`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q2t7_blog`
--
ALTER TABLE `q2t7_blog`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q2t11_good`
--
ALTER TABLE `q2t11_good`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q2t13_vote`
--
ALTER TABLE `q2t13_vote`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q3t5_effect`
--
ALTER TABLE `q3t5_effect`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q3t5_img`
--
ALTER TABLE `q3t5_img`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q3t7_movie`
--
ALTER TABLE `q3t7_movie`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q3t8_book`
--
ALTER TABLE `q3t8_book`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t4_class`
--
ALTER TABLE `q4t4_class`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t5_product`
--
ALTER TABLE `q4t5_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t8_order`
--
ALTER TABLE `q4t8_order`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t9_user`
--
ALTER TABLE `q4t9_user`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t10_admin`
--
ALTER TABLE `q4t10_admin`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `q4t11_footer`
--
ALTER TABLE `q4t11_footer`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
